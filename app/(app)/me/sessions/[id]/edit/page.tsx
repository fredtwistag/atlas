  ...
  "ses-2": [
    {
      ...
      kind: "workaround",
      summary:
        "Rush orders are tracked in a personal notebook when the system can't flag them.",
    },
    {
      id: "e-5",
      kind: "handoff",
      summary: "Warehouse picking stalls waiting on the credit-hold release.",
    },
  ],
  "ses-3": [
    {
      ...
      kind: "tooling",
      summary:
        "Order status lives in the ERP but CS has no read access, so they ping Order Ops.",
    },
  ],
};
